...
Although globally more women are accessing the internet every year, in lowincome countries, only 20 per cent are connected. The gender digital divide creates a data gap that is reflected in the gender bias in AI.
...
'When technology is developed with just one perspective, it's like looking at the world half-blind,' concurred Mahfouz. She is currently working on a project to create an AIpowered platform that would connect Afghan women with each other.
...
'To prevent gender bias in AI, we must first address gender bias in our society,' said Do ğ uç from Turkey.
...
In a rapidly advancing AI industry, the lack of gender perspectives, data, and decisionmaking can perpetuate profound inequality for years to come.
...
COPYRIGHT INFORMATION SECURITY PRIVACY POLICY REPORT WRONGDOING TERMS OF USE