...
How to solve the most pressing problems of AI governance in a context of extremely high concentration of ownership of AI systems, their infrastructure, software, data and knowledge? How to make AI systems and their governance more democratic, participatory, and closer to the lives and experiences of underprivileged communities? How to make AI systems responsive to global justice and the survival of the planet? How can we imagine fair, equitable and inclusive AI systems in the pursuit of universal access to human rights?
...
1 February 2024  Last update:23 September 2025

Author: Paola Ricaurte, Tecnologico de Monterey, Berkman Klein Center for Internet &amp; Society, Tierra Común Network, Feminist AI Research Network

As we navigate the rapidly evolving landscape of artificial intelligence technologies, we must ensure that our ethical frameworks and governance structures reflect the principles of diversity, equity, and inclusion, contributing to the achievement of multidimensional justice. In this text, we will explore how a feminist perspective on AI governance can be instrumental in advancing gender equality and diversity throughout the full AI life cycle. Additionally, I will provide examples of initiatives that showcase the experiences of adopting feminist approaches to AI governance.
...
## Feminist AI In Practice: technologies, policy, research

In this section, I will share three initiatives that approach AI governance, development, policy, and research following feminist principles. These initiatives involve various stakeholders: practitioners, civil society, and academia; nation-states; and intergovernmental organizations.

Incubating Feminist AI in Latin America: practitioners, civil society, and academia

In the past three years, my work has been deeply intertwined with the Incubating Feminist AI project, focused on the development of feminist AI in three regions: Latin America and the Caribbean (LAC, Middle East and North Africa and South East Asia, funded by the International Development Research Center (IDRC. In this case I will refer only to my experience as leader of the LAC hub of the Feminist AI research network in which the Incubating Feminist AI project emerged, as part of the &lt;A Alliance  .
...
## Feminist AI Policy: Argentine Ministry of Foreign Affairs and UNESCO
...
Safeguarding human rights and judicial independence in the age of algorithmic justice
...
World Futures Day 2025 UNESCO advances futures literacy
