...
3. Debnath, A., Cranefield, S., Lorini, E., Savarimuthu, B.T.R.: Supplementary material for the paper "Can LLMs Reason About Trust?". Dataset (2025), 2. Castelfranchi, C., Falcone, R., Lorini, E.: A non-reductionist approach to trust. In: Computing with Social Trust, pp. 45-72. Springer (2009)
...
9. Lewis, J.D., Weigert, A.: Trust as a social reality. Social Forces 63 (4), 967-985 (1985). 8. Herzig, A., Lorini, E., Hübner, J.F., Vercouter, L.: A logic of trust and reputation. Logic Journal of the IGPL 18 (1), 214-244 (2010)
