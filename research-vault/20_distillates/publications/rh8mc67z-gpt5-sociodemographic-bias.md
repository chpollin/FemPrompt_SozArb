...
reference: RH8MC67Z
record-id: RH8MC67Z
work-id: work:ca3ae89d-5ddd-5036-a44d-165c58097219
...
A snapshot experiment tested identical clinical vignettes with 31 sociodemographic labels and an adversarial false chart element. The authors report systematic variation in escalation, mental-health screening and testing, plus a 65% unmitigated hallucination rate reduced to 7.67% by a mitigation prompt.

> "Adversarially, GPT-5 elaborated (hallucinated) on planted fabrications in 65% of runs" (bound Version, source text)
...
The evaluation is a time-bound model snapshot. Subgroup differences are descriptive in this replication, and no formal significance testing was performed. Figures and visual layout were not independently inspected during preparation.
