...
| `review-cases/verify-source-assets.mjs` | Optional visual source assets: safe repository paths, PNG signature and byte hash, provenance, license, missing/stale assets and prepared/completed-run checks. Included in `npm test`. |
