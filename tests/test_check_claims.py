...
def _layer(tmp_path, claim_text, distillate="# Titel\n\n## Kernbefund\n\nText.\n"):
...
def test_missing_heading_still_fails(tmp_path):
...
def test_real_reference_beside_an_example_resolves(tmp_path):
    claims, dist = _layer(
        tmp_path,
