...
| [methods-and-pipeline.md](methods-and-pipeline.md) | PRISMA, Assessment-Design (10 Kategorien, dualer Bewertungspfad, Benchmark), Pipeline (PDF -> Markdown -> Knowledge -> Vault), Script-Referenz, Kosten |
| [status.md](status.md) | Meilensteine (M1-M9), Benchmark-Ergebnisse, Selektions-Audit, offene Punkte |
