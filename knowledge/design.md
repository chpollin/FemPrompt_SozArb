...
- Checklists. PRISMA 2020 (27 items) and PRISMA-trAIce (14 items, each with a priority level), a trackable list with per-item status and notes; some items auto-satisfy from session data.
