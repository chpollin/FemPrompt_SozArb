...
The source audit of 2026-09-21 identified bibliographic conflicts behind otherwise matching local texts. *Recommendations for social work researchers and journal editors on the use of generative AI and large language models* (`AMYZFAPH`, DOI `10.1086/726021`) and *ChatGPT for social work science: Ethical challenges and opportunities* (`ZITLBM8A`, DOI `10.1086/726042`) have corpus author lists inconsistent with their article title pages. *Algorithmic decision-making in social work practice and pedagogy: confronting the competency/critique dilemma* (`QI5AYE4V`, `H59BNSX8`, DOI `10.1080/02615479.2023.2195425`) additionally requires a distinction between its online publication in 2023 and issue publication in 2024. Correct these bibliographic inputs before source admission. A retry that omits the embedded metadata would bypass the existing author and year guards. The literal source titles and DOIs were checked in the original Markdown conversions; this finding does not change Zotero or historical annotations.
