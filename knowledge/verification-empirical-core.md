...
**Reproduced with findings attached:** claim a (291 pairs of 303 human and 326 LLM rows reproduces; one upstream discrepancy against `papers_full.csv` remains open) and claim g (the merge fix is real in code and in the current artifacts).
