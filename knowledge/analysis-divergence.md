...
related: [methods, plan, standards, journal, project, INDEX]
---
...
The document analyses the round-1 screening divergence and reports it decomposed, under the framing decided on 2026-06-09 and 2026-07-03 (the V-section consequence ledger in [[plan]]). The divergence is a motivating illustration for the epistemic infrastructure, showing why reliability has to be established by process design rather than presupposed of the model. The finding carries a second reading alongside the motivating one. It demonstrates what the recorded infrastructure makes analysable, because the decomposition into a workflow-criteria share and a content-judgement share rests on the per-decision reasons the workflow recorded at the moment of the run; had those reasons not been kept, the separation would be unavailable and the workflow-criteria share of the divergence unrecoverable. It is not a finding the review defends. The expert track is the epistemically binding reference (see [[project]] and [[methods]]); the review's substance is the corpus and its categorisation. The document withholds any error-rate reading, since the human track carries no independent inter-human baseline for round 1. Divergence is reported as divergence.
...
- The assessment temperature and the confidence threshold were not recorded (trAIce M6b in [[standards]]), so the disclosure cannot state them.
