---
title: Faires_KI-Prompting___Ein_Leitfaden_f_r_Unternehme
authors:
  - Unknown Author
year: 2024
type: research-paper
...
# Faires_KI-Prompting___Ein_Leitfaden_f_r_Unternehme
...
---
source_file: Faires KI-Prompting – Ein Leitfaden für Unternehme.pdf
conversion_date: 2025-08-06T14:04:44.393350
---
...
Generative Künstliche Intelligenz begegnet uns heute in vielen Formen - von Textgeneratoren, die Marketinginhalte erstellen, bis hin zu Bildgenerierungstools, die Bewerber*innen-
...
Eva Gengler, eva.gengler@enableYou.de Andreas Kraus, andreas.kraus@enableYou.de Kristina Bodrožić-Brnić, kristina.brnic@businessschool-berlin.de
...
Aufforderung - eine bestimmte Aufgabe oder Tätigkeit, die das Modell ausführen soll. Beispiel: 'Erkläre mir Generative Künstliche Intelligenz.'
...
- Kontext &amp; Zusatzinformationen - erweiterter Kontext oder ergänzende Informationen, die dem Modell helfen, treffendere Outputs zu erzeugen. Beispiel: 'Ich bin Anfängerin in der Nutzung Generativer KI und will die Grundlagen 3
...
- Rolle 4
- eine Rolle, welche die KI für ihr Ergebnis einnehmen soll.

Beispiel: 'Nimm die Rolle einer Lehrer*in ein, die mir Generative KI näher bringt.'

- Einschränkungen, Verbote &amp; Pflichten - Vorgabe von Grenzen und Richtung. 5

Beispiel: 'Du musst in einem Stil schreiben, den ein 10-jähriges Kind verstehen kann.'

<!-- image -->

- eine gewünschte Form oder Struktur der Ergebnisse.

- Output-Format Beispiel: 'Erstelle eine Liste mit jeweils kurzen Erklärungen.' 6
...
- Schreiben, was zu tun ist , anstatt, was nicht zu tun ist. 5
- Variation des gewünschten Output-Formats und Stils nutzen (z.B. Schreibstil). 6
...
Nutzen von Feedback-Funktionen , um die Ergebnisse zu verbessern.

<!-- image -->

6

Verbote &amp; Pflichten formulieren für klare Grenzen oder eine klare Richtung des Ergebnisses.
...
| DALL-E 2     | DeepDream    | Stable Diffusion   | Midjourney      | Magic Media   | BigGAN Hochauf-   |
|--------------|--------------|--------------------|-----------------|---------------|-------------------|
| Detaillierte | Veränderung  | Realistische       | Surreale und    | Verschiedene  |                   |
| Bilder       | von Bildern  | Bilder             | kreative Bilder | Bilder        | lösende Bilder    |
| Imagen       | StyleGAN     | Missjourney        | Firefly         | Leonardo.Ai   | Artbreeder        |
| Verschiede-  | Realistische | Bilder von         | Abstrakte und   | Realistische  | Generierung       |
| ne Arten von | Bilder       | Frauen in          | experimentelle  | Bilder        | von Menschen      |
| Bildern      |              | Berufen            | Bilder          |               | und Tieren        |
...
Textgenerierung: ChatGPT 4, Gemini

Bildgenerierung: DALL-E 2, Midjourney

Kontext: Stellenausschreibungen und Empfehlungsschreiben mit Text und Bildern
...
Generative KI kann Stereotype verstärken, indem sie diese in ihren Ergebnissen immer wieder reproduziert.  Dies  kann  zu  einer  unfairen  Darstellung von marginalisierten, unterprivilegierten oder unterrepräsentierten Gruppen führen. Gerade bei
...
Menschen, die bisher schon Benachteiligung erfahren haben
...
Lisa Krawczyk (shelher)

Content Marketing Managerin bei presigno Unternehmenskommunik .. 6 Monate

<!-- image -->

Aus Selfies ein professionelles Profilbild für Linkedin erstellen lassen? Dank KI kein Problem. Oder doch?

Quellen: zdfheute, LinkedIn

## So fettphobisch istKI
...
Realismus von OpenAl-Videogenerator Sora weckt DeepfakeÄngste

Der hohe Realismus des Sora-Videogenerators von OpenAl weckt Ängste vor Deepfake-Videos für politische Kampagnen. Das KI-Tool ist in der Lage, anhand von Text-Befehlen täuschend echte Videos zu erstellen. Kommunikationswissenschaftler in Mitteldeutschland haben eine unterschiedliche Sicht die Problematik. auf
...
Auch das Design von KI spielt eine xxxxxxxxxxwichtige Rolle in der Entwicklung und xxxxxxxim Einsatz von KI. Der Designprozess um-
...
fasst die Auswahl der Daten, die Entwicklung des Algorithmus und den Einsatz der KI in der Praxis.
...
Tonalität: Die Tonalität in der Sprache des Prompts hat einen Einfluss auf das Ergebnis. Hier sollten Sie auf eine klare und direkte Sprache achten. Zynismus, Sarkasmus und Humor werden im Zweifel nicht verstanden. Ein gewisser Befehlston kann im Umgang mit aktuellen Generativen KI-Systemen nicht schaden.
...
Eva Gengler enableYou Consulting GmbH &amp; feminist AI E-Mail: eva.gengler@enableYou.de Telefon: +49 157 70250777
